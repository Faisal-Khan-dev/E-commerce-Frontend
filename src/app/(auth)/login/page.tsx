      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full mt-2 py-4 bg-[#413126] text-white text-xs font-semibold uppercase tracking-widest rounded-sm transition-colors duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
          >
          ...
          <button
            ...
            className="w-full py-3.5 bg-white border border-zinc-300 text-zinc-700 text-xs font-semibold uppercase tracking-widest rounded-sm transition-all duration-200 flex items-center justify-center gap-3 disabled:opacity-50 cursor-pointer"
          >
  ...
  return (
    <main className="w-full min-h-screen grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex flex-col justify-center px-8 sm:px-16 lg:px-24 xl:px-32 bg-[#fcf9f6]">
        <Suspense fallback={<div className="text-center py-10 text-zinc-400 text-sm">Loading...</div>}>
          <LoginForm />
        </Suspense>
      </div>
    </main>
