    ...
    <section className="w-full bg-[#fcf9f6] py-20 sm:py-28 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="min-h-[160px] sm:min-h-[120px] flex items-center justify-center mb-8">
          <p
            className={`text-xl sm:text-2xl lg:text-3xl font-serif text-zinc-900 italic tracking-wide leading-relaxed max-w-3xl text-balance transition-all duration-300 transform ${
              isFading
        ...
        <span
          className={`text-xs font-semibold tracking-[0.2em] uppercase text-zinc-500 block mb-10 transition-all duration-300 ${
        ...
        <div className="flex items-center gap-3">
          {TESTIMONIALS.map((_, idx) => (
            <button
              ...
              className={`h-1 transition-all duration-300 ease-out rounded-full cursor-pointer ${
                idx === activeIndex
                  ? "w-10 bg-[#312117]"
